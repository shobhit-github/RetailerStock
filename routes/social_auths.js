...
var UserSchema = require('../models/users').schema;
  
var SocialUser = UserSchema.extend({
  social_access : { 
    bitbucket: String, facebook: String, foursquare: String, google: String, github: String, instagram: String, linkedin: String, live: String, yahoo: String, twitter: String, twitch: String, spotify: String
  }
});



var User = mongoose.model('SocialUser', SocialUser);
